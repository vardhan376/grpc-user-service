...
import (
	...
	codes "google.golang.org/grpc/codes" // error handling is used for codes and status
...
const (
	UserService_GetUserData_FullMethodName = "/proto.UserService/GetUserData"
)
...
//
// Service jo server implement karega
...
func (UnimplementedUserServiceServer) GetUserData(context.Context, *UserRequest) (*UserResponse, error) {
